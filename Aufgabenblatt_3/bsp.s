...
//# Diese Datei enthält den ARM Assembly code des C quellcodes bsp
...
; %bb.0:
	...
	stur	wzr, [x29, #-4]
	mov	w8, #45575						; hier wird die variable i initialisiert
	movk	w8, #1, lsl #16
	stur	w8, [x29, #-8]
	mov	w8, #39922						; hier wird die variable j initialisiert
	movk	w8, #65532, lsl #16
	stur	w8, [x29, #-12]
	mov	w8, #41301						; hier wird die variable k initialisiert
